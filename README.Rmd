...
unzip("tests/testthat/project_miceps.zip", exdir = "tests/testthat")

unzip("tests/testthat/project_noob.zip", exdir = "tests/testthat")

if(fs::dir_exists("tests/testthat/__MACOSX")){
    fs::dir_delete("tests/testthat/__MACOSX")
  }
...
fs::dir_delete("tests/testthat/project_noob")
fs::dir_delete("tests/testthat/project_miceps")
